...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path pt-3">
        ...
        <div class="card mb-2 fm-upload-wrapper" style="display:block;">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> Cargar desde URL</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
<head>
    ...
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="https://campus.potentor.com.mx/favicon.ico" type="image/png">
    ...
    <!--- CSS PORTAL DEL EMPLEO -->
    <link rel="stylesheet" href="http://campus.potentor.com.mx/css/perfil.css">
    <link href="style_portal_del_empleo.css" rel="stylesheet">
    <!--- CSS PORTAL DEL EMPLEO -->
...
<div class="wrapper">
    <div class="main container-fluid">
        <div class="row">
            <div class="col-md-3">
                <div class="panel profile-sidebar">
                    ...
                    <div class="profile-userpic">
                        <img src="images/avatar_mafer.jpg" id="avatar" class="img-responsive" data-src="images/avatar_mafer.jpg" data-src-retina="images/avatar_mafer.jpg">
                    </div>
                    <!-- END SIDEBAR USERPIC -->
                    <!-- SIDEBAR USER TITLE -->
                    <div class="profile-usertitle">
                        <div class="profile-usertitle-name">
                            Maria Fernanda Carrizales Loya
                        </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default center-container">
                    <div class="panel-body">
                        <h3 class="principal_title" style="display: inline;">Documentos</h3>
                        <a title="<?php echo lng('Upload') ?>" class="btn btn-primary btn-xs" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> <?php echo lng('Upload') ?></a>

                            <a title="<?php echo lng('NewItem') ?>" class="btn btn-primary btn-xs" href="#createNewItem" data-toggle="modal" data-target="#createNewItem"><i class="fa fa-plus-square"></i> <?php echo lng('NewItem') ?></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></button>
            ...
            <div class="col-md-3">
                <div class="panel panel-default right-container">
                    <div class="panel-body">
                        ...
                        <p>
                            <a href="#!">Team building Marketing Digital</a><br/>
                            09/19/19
                        </p>
                        <p>
                        ...
                        <h3>Cumpleaños</h3>
                        <p>
                            <a href="#!">Ana Lucía Ortega</a><br/>
                            Hoy
                        </p>
                        <p>
                            <a href="#!">Federico Guterrez Galván</a><br/>
                            04 de diciembre
                        </p>
...
function lng($txt) {
    ...
    $tr['en']['Save']           = 'Guardar';                   $tr['en']['SelectAll']       = 'Select all';
    $tr['en']['UnSelectAll']    = 'Unselect all';           $tr['en']['File']               = 'Archivo';
    $tr['en']['Back']           = 'Regresar';                   $tr['en']['Size']           = 'Tamaño';
    $tr['en']['Perms']          = 'Permisos';                  $tr['en']['Modified']        = 'Modificado';
    $tr['en']['Owner']          = 'Dueño';                  $tr['en']['Search']             = 'Bucar';
    $tr['en']['NewItem']        = 'New Item';               $tr['en']['Folder']             = 'Folder';
    $tr['en']['Delete']         = 'Eliminar';                 $tr['en']['Rename']           = 'Rename';
    ...
    $tr['en']['InvertSelection']= 'Invert Selection';       $tr['en']['DestinationFolder']  = 'Ruta de destino';
    $tr['en']['ItemType']       = 'Item Type';              $tr['en']['ItemName']           = 'Item Name';
    $tr['en']['CreateNow']      = 'Nuevo';                  $tr['en']['Download']           = 'Descargas';
    $tr['en']['Open']           = 'Abrir';                  $tr['en']['UnZip']              = 'UnZip';
    $tr['en']['UnZipToFolder']  = 'UnZip to folder';        $tr['en']['Edit']               = 'Editar';
    $tr['en']['NormalEditor']   = 'Normal Editor';          $tr['en']['BackUp']             = 'Back Up';
    $tr['en']['SourceFolder']   = 'Source Folder';          $tr['en']['Files']              = 'Archivos';
    $tr['en']['Move']           = 'Mover';                   $tr['en']['Change']             = 'Change';
    $tr['en']['Settings']       = 'Settings';               $tr['en']['Language']           = 'Lenguaje';
    $tr['en']['MemoryUsed']     = 'Memory used';            $tr['en']['PartitionSize']      = 'Partition size';
    $tr['en']['ErrorReporting'] = 'Error Reporting';        $tr['en']['ShowHiddenFiles']    = 'Mostrar archivos ocultos';
    $tr['en']['Full size'] 		= 'Full size';				$tr['en']['Help'] 				= 'Ayuda';

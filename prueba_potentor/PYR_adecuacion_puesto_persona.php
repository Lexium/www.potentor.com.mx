...
<section class="generic_page">
    <div class="container mt-3 py-5">
        <div class="row mb-5">
            <div class="col-md-6">
                <h5 class="aqua_color"><?=lang('Adec puesto/persona');?></h5>
                <h2><?=lang('APP_text01');?></h2>
                <p class="mb-4"><?=lang('APP_text02');?></p>
                <a class="btn btn_orange" data-toggle="modal" data-target=".solDemo_int" ><?=lang('Solicitar Demo')?></a>
            </div>
            <div class="col-md-6 characteristics">
                <ul>
                    <li class="first">
                        <h5><?=lang('APP_text03');?></h5>
                        <p><?=lang('APP_text04');?></p>
                    </li>
                    <li class="second">
                        <h5><?=lang('APP_text05');?></h5>
                        <p><?=lang('APP_text06');?></p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row d-flex align-items-center functionality">
            <div class="col-md-6">
                ...
                <h4><?=lang('APP_text08');?></h4>
                <p><?=lang('APP_text09');?></p>
                <h4><?=lang('APP_text10');?></h4>
                <p><?=lang('APP_text11');?></p>
                <h4><?=lang('APP_text12');?></h4>
                <p><?=lang('APP_text13');?></p>
            </div>
            <div class="col-md-6 text-center">
                <img class="img-fluid" src="images/nivel-de-apego.png">
            </div>
        </div>
    </div>
    <div class="testimonials text-center py-5 bg_gray">
        <div class="container">
            ...
            <div class="guest">
                <img src="images/salvador_luna_Marykay.png"  width="140px"  class="mb-3" />
                <?=lang('TES_MK_NAME');?>
            </div>
        </div>
